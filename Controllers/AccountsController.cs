    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            try
            {
                ...
                await _context.SaveChangesAsync();
                _logger.LogInformation("Verification code generated for user: {UserId}", user.UserID);

                // Send verification email (fire and forget - don't await if it's causing delays)
                _ = Task.Run(async () =>
                {
                    try
                    {
                ...
                // Set session and redirect immediately
